MAXBINS_A_TI_4:(MAXBINS_A_TI_4.bit)
...
The bitstream contains only I slices and one slice per picture. All intra configuration. Checksum SEI messages are included.
