MAXBINS_C_TI_4:(MAXBINS_C_TI_4.bit)
...
The bitstream contains I and B slices and one slice per picture. Random access configuration. Checksum SEI messages are included.